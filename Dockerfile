...
# sendgrid-dev
RUN curl -L -o /usr/local/bin/sendgrid-dev https://github.com/Luminoso-256/sendgrid-dev/releases/download/v0.9.5/sendgrid-dev_$(if [ $(uname -m) = "aarch64" ]; then echo aarch64; else echo x86_64; fi)
